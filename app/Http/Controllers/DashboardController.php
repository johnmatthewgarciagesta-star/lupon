...
class DashboardController extends Controller
{
    public function index()
    {
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Dashboard loading error: ' . $e->getMessage());

            return Inertia::render('dashboard', [
                'error' => 'A database error occurred while loading the dashboard. Please contact the administrator. Details: ' . $e->getMessage(),
                ...
                'typeStats' => [],
                'monthlyStats' => [],
                'documentStats' => ['total' => 0, 'by_type' => [], 'recent' => []],
            ]);
        }
    }
}
